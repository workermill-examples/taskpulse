...
describe("Projects API Routes", () => {
  ...
  describe("PUT /api/projects/[slug]", () => {
    it.skip("should update project with ADMIN role", async () => {
      const mockAccessResult = {
        user: mockUser,
  ...
  describe("POST /api/projects/[slug]/members", () => {
    ...
    it.skip("should return 409 for already existing member", async () => {
      const mockAccessResult = {
        user: mockUser,
        membership: { ...mockMembership, role: "ADMIN" as const },
        project: mockProject,
  ...
  describe("PUT /api/projects/[slug]/members/[id]", () => {
    it.skip("should update member role with ADMIN permissions", async () => {
      const mockAccessResult = {
        user: mockUser,
        membership: { ...mockMembership, role: "ADMIN" as const },
        project: mockProject,
    ...
    it.skip("should prevent demoting last OWNER", async () => {
      const mockAccessResult = {
        user: mockUser,
        membership: mockMembership, // OWNER role
        project: mockProject,
  ...
  describe("DELETE /api/projects/[slug]/members/[id]", () => {
    ...
    it.skip("should prevent last OWNER from leaving", async () => {
      const mockAccessResult = {
        user: mockUser,
        membership: mockMembership, // OWNER role
        project: mockProject,
